...
def notif1_page():
    ...
    notif2Btn = ctk.CTkButton(root, text="Notif 2", command = notif2_page)
    notif2Btn.pack()
    closeBtn = ctk.CTkButton(root, text="Close", command = root.destroy)
    closeBtn.pack()
...
def notif2_page():
    ...
    notif1Btn = ctk.CTkButton(root, text="Notif 1", command = notif1_page)
    notif1Btn.pack()
    closeBtn = ctk.CTkButton(root, text="Close", command = root.destroy)
    closeBtn.pack()
